...
You need PHP installed and available in your terminal that has `stty` support.
...
Code is whatever, do you want with it, I don't care. If you want please credit me if you use it for something tho.
